...
| **273/2026/NĐ-CP** | 08/07/2026 | **Về kinh doanh hàng miễn thuế** | Tài chính / Hải quan / Du lịch | vanban.chinhphu.vn (docid **218801**) | **Chờ review** | Commit PR #248 — cần sửa OCR: `Căn cú`→`Căn cứ` (L48), `Điễu`→`Điều` (L60), 8×`„` artifact (Đệ #4 review 2026-07-10 01:32) |
| **263/2026/NĐ-CP** | ~07/2026 | **Quy định về khu nông nghiệp ứng dụng công nghệ cao** | Nông nghiệp / KHCN | vanban.chinhphu.vn (docid **218800**) | **Chờ review** | Commit PR #248 — cần sửa: duplicate header block L54-68, `Căn cú`→`Căn cứ` (L1304), `„đồ`→`đồ`, metadata group/tags chuẩn hóa (Đệ #4 review 2026-07-10 01:32) |
