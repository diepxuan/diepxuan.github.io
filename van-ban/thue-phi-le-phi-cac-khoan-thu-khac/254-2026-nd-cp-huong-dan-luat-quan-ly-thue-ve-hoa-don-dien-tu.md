...
| Ngày có hiệu lực | 1/7/2026 |
| Cơ quan ban hành | Chính phủ |
| Căn cứ pháp lý | Luật Tổ chức Chính phủ 63/2025/QH15; Luật Quản lý thuế 108/2025/QH15 |
| Văn bản thay thế | NĐ 123/2020/NĐ-CP; Điều 1 NĐ 41/2022/NĐ-CP; NĐ 70/2025/NĐ-CP |
| Ghi chú | Thay thế toàn bộ các nghị định về hóa đơn, chứng từ trước đó |
...
đ) Tổ chức nước ngoài (bao gồm cả chủ quản nền tảng thương mại điện
...
luật thuê; tổ chức, cá nhân khai thay, nộp thuế thay theo quy định của pháp luật
về thuế và pháp luật về quản lý thuế.

6. Tổ chức cung cấp dịch vụ hóa đơn điện tử, chứng từ điện tử.
7. Cơ quan quản lý thuế.

đ) Các tổ chức, cá nhân có liên quan đến việc quản lý, sử dụng hóa đơn và
chứng từ.
...
quan thuê cấp mã trước khi người bán gửi cho người mua.

Mã của cơ quan thuế trên hóa đơn điện tử bao gồm số giao dịch là một dãy
số duy nhật do hệ thông của cơ quan thuế tạo ra và một chuôi ký tự được cơ
...
mua hàng hóa, dịch vụ có ngày lập trên hóa đơn từ ngày cơ quan thuế xác định
bên bán không hoạt động tại địa chỉ kinh doanh đã đăng ký với cơ quan nhà
nước có thẩm quyền; sử dụng hóa đơn, chứng từ mua hàng hóa, dịch vụ có ngày
...
việc mua bán hàng hóa, dịch vụ không có thật một phần hoặc toàn bộ); sử dụng,
...
khẩu trừ thuế, người nộp thuế, nộp phí, lệ phí và phải ghi đầy đủ các nội dung
...
### Điều 5. Bảo quản, lưu trữ hóa đơn, chứng từ và chuyển đỗi hóa đơn
...
hoặc cơ sở có hàng hóa gửi bán (gọi chung là cơ sở giao hàng) để cơ sở giao
...
Trường hợp cơ sở có số lượng và doanh số hàng hóa bán ra lớn, bảng kê
có thể lập cho 05 ngày hay 10 ngày một lần. Trường bợp hàng hóa bán ra có
thuế suất thuế giá trị gia tăng khác nhau phải lập bảng kê riêng cho hàng hóa
...
tài sản nhập khẩu); khi lập hóa đơn, tông số tiền thuế giá trị gia tăng trên hoá
...
g)3) Xử lý lập hóa đơn khi hợp đồng cho thuê tài chính chấm đứt trước
thời hạn:
...
đ) Các trường hợp theo quy định tại điểm a, điểm b khoản 1 Điều 6, điểm
...
chậm nhất là ngày cuôi cùng của thời hạn kê khai, nộp thuế đôi với tháng phát
...
tổ chức kinh tế nộp thuế theo phương pháp khẩu trừ phải ghi rõ nội dụng giá
...
tiệt một số điều của Luật Quản lý, sử dụng tài sản công.
...
điện tử có mã của cơ quan thuế nhưng gặp sự cô dẫn đến không sử dụng được
...
hiện việc lập, cấp mã hoặc truyền đữ liệu hóa đơn điện tử đúng thời hạn:

a) Trong vòng 03 ngày làm việc kể từ ngày sự cố được khắc phục, người
bán được thực hiện việc lập và gửi hóa đơn điện tử tới cơ quan thuế;
...
khi nhận được hóa đơn điện tử có mã của cơ quan thuế; cuối ngày gửi dữ liệu
26
...
người bán thực hiện chuyền đữ liệu hóa đơn điện tử đến cơ quan thuế băng hình
thức gửi trực tiêp:
...
công ty mẹ chuyển toàn bộ dữ liệu hóa đơn điện tử bao gồm cả dữ liệu của các công
...
trưởng Bộ Tài chính quy định và gửi đền Hệ thông thông tin quản lý thuế theo
quy định.
...
qua nền tảng thương mại điện tử, nền tảng số.
...
với cơ quan thuế thì thực hiện truyền dữ liệu hóa đơn điện tử, chứng từ điện tử
...
thu nhập cá nhân không phải lập chứng từ khâu trừ thuế thu nhập cá nhân.
...
đã được tổ chức chỉ trả hoặc tổ chức. khẩu trừ thuế thực hiện khẩu trừ, nộp thuế
...
nhiệm (hình thức, loại, ký hiệu, số lượng biên lai (từ số... đên số...)); mục đích
...
phí (bên ủy nhiệm) và không bắt buộc có chữ ký số của bên ủy nhiệm và phải
...
từ khâu trừ thuế thu nhập cá nhân điện tử gửi cho người bị khâu trừ thuê, đồng
...
trừ thuế thu nhập cá nhân điện tử đến cơ quan thuế theo định dạng, chuẩn dữ
...
lai (trừ phí hải quan; lệ phí hàng hóa, hành lý, phương tiện vận tải quá cảnh)
...
tin hóa đơn, chứng từ tại cơ quan thuế địa phương;
...
yêu cầu quản lý, không yêu cầu cung cấp hóa đơn giấy. Các cơ quan có liên
...
phá, Thuế cơ sở cung cấp thông tin đối với đề nghị của cơ quan, tổ chức quản
lý đồng cấp.
...
Chính phủ sửa đổi, bổ sung một số điều của Nghị định số 123/2020/NĐ-CP
...
c)Nghị định số 70/2025/NĐ-CP ngày 20 tháng 3 năm 2025 của Chính phủ
...
bán hàng hóa có nhiêu chủng loại khác nhau thì tên hàng hóa thể hiện chi tiết
...
đơn vị đo lường theo quy định pháp luật về đo lường (ví dụ như: tấn, tạ, yến, kilôgam, gam, mg, lượng, can, thùng, bao, gói, tuýp, mẻ, mề,
...
pháp khâu trừ thì bảng kê phải có tiêu thức “ “thuế suất thuế giá trị gia tăng” v.
...
tỷ đặt dấu chấm (.), nếu có ghỉ chữ số sau chữ số hàng đơn vị đặt dấu phây (@)
...
chiếu phim mà người mua là cá nhân không cung cấp tên, địa chỉ, số định đanh
...
theo quy định của Chính phủ thì trên hóa đơn không nhất thiết phải có đơn vị tính; số lượng; đơn giá; phần tên hàng hóa, dịch vụ đã cung cấp hàng hóa, địch
