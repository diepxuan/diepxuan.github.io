...
Mã định danh địa điểm là dãy số tự nhiên gồm 12 chữ số do Cơ sở dữ liệu định danh địa điểm xác lập. Mỗi địa điểm được gắn một mã định danh riêng biệt, không trùng lặp, bảo bảo tính ổn định, mở rộng và khả năng liên kết, tích hợp, kết nối, chia sẻ, khai thác thông tin trong cơ sở dữ liệu quốc gia, cơ sở dữ liệu chuyên ngành.
