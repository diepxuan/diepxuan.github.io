...
try:
    ...
    print("ERROR: Missing 'beautifulsoup4' library. Install with: pip install beautifulsoup4")
    sys.exit(1)

try:
    from dateutil import parser
except ImportError:
    print("ERROR: Missing 'python-dateutil' library. Install with: pip install python-dateutil")
    sys.exit(1)

# markdownify is optional
try:
